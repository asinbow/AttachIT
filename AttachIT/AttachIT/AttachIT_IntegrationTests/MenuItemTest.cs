...
namespace AttachIT_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(asinbow.AttachIT.GuidList.guidAttachITCmdSet, (int)asinbow.AttachIT.PkgCmdIDList.cmdidAttachIT);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "AttachIT", "asinbow.AttachIT.AttachITPackage");
