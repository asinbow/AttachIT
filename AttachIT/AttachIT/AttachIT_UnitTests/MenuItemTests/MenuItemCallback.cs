...
using asinbow.AttachIT;

namespace AttachIT_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new AttachITPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(asinbow.AttachIT.GuidList.guidAttachITCmdSet, (int)asinbow.AttachIT.PkgCmdIDList.cmdidAttachIT);
